...
import com.appointment.tutionservice.databinding.ActivityCustomerPrivacyPolicyBinding
...
class CustomerPrivacyPolicy : AppCompatActivity() {
    private lateinit var binding: ActivityCustomerPrivacyPolicyBinding

    @OptIn(DelicateCoroutinesApi::class)
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCustomerPrivacyPolicyBinding.inflate(layoutInflater)
