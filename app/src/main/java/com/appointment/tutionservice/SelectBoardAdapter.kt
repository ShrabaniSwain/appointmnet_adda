...
class SelectBoardAdapter() : RecyclerView.Adapter<SelectBoardAdapter.CardViewHolder>() {

    private val selectBoard = listOf(
        "CBSE",
        "WBSEC",
        "Bihar Board",
        "AP Board",
    ...
    override fun onBindViewHolder(holder: CardViewHolder, position: Int) {
        val item = selectBoard[position]
        holder.bind(item)

    }

    override fun getItemCount(): Int {
        return selectBoard.size
    }
