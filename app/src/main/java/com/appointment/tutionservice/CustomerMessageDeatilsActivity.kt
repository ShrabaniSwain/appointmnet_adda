...
import com.appointment.tutionservice.databinding.ActivityCustomerMessageDeatilsBinding
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class CustomerMessageDeatilsActivity : AppCompatActivity() {
    private lateinit var binding: ActivityCustomerMessageDeatilsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCustomerMessageDeatilsBinding.inflate(layoutInflater)
            ...
            override fun onResponse(call: Call<JobPostMessagesResponse>, response: Response<JobPostMessagesResponse>) {
                if (response.isSuccessful) {
                    if (response.body()?.status == 1) {
                        ...
                        messageAdapter = CustomerMessageAdapter(this@CustomerMessageDeatilsActivity, message)
            ...
            override fun onResponse(call: Call<MessageResponse>, response: Response<MessageResponse>) {
                ...
                if (response.isSuccessful) {
                    if (response.body()?.status == 1) {
                        ...
                        val intent = Intent(applicationContext, CustomerMessageDeatilsActivity::class.java)
