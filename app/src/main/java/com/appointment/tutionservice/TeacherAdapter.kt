...
import com.appointment.tutionservice.databinding.TeacherItemListBinding

class TeacherAdapter(val service: List<ServiceItem>, val context: Context): RecyclerView.Adapter<TeacherAdapter.CardViewHolder>() {

    private var filteredMarketItems: List<ServiceItem> = service

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CardViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.teacher_item_list, parent, false)
    ...
    inner class CardViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val binding = TeacherItemListBinding.bind(itemView)
        ...
        fun bind(notificationText: ServiceItem) {
            ...
            binding.btnBookAppointment.setOnClickListener {
                ...
                Log.i("TAG", "bind: " + Constant.JOBTITLE + " " + Constant.SERVICE_ID)
